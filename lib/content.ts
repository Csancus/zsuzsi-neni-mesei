...
export const categories: Category[] = [
  { id: "allatos", name: "Állatos mesék", emoji: "🦊", blurb: "Erdei és háztáji szereplők, barátság és bátorság." },
  { id: "tundermese", name: "Tündérmesék", emoji: "🧚", blurb: "Varázslat, királylányok, hét próba." },
  { id: "kalandos", name: "Kalandos mesék", emoji: "🗺️", blurb: "Térkép, hajó, elveszett kincs – pörgős fordulatok." },
  ...
  { id: "termeszet", name: "Természet és évszakok", emoji: "🍂", blurb: "Eső, hó, magvak, csillagok – közben tanul is." },
